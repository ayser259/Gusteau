...
class FoodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Food
        fields = ('name', 'cal', 'weight', 'diet_type', 'average_rating', 'fat', 'fat_percent', 'sat_fat','sat_fat_percent', 'carbs', 'carbs_percent', 'sodium', 'sodium_content', 'protein', 'protein_percent')
...
class FavoriteLocationSerializer(serializers.ModelSerializer):
    ...
    location = serializers.CharField(source='location.name',read_only=True)
    class Meta:
        model = FavoriteLocationSerializer
        fields =('username','first_name','surname','location')
